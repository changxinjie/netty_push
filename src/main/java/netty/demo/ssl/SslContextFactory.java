...
public final class SslContextFactory {
    ...
    private static String path = "G:/mengdian/netty/resource/";
    private static String CLIENT_KEY_STORE = path + "netty_client.cer";
    private static String CLIENT_TRUST_KEY_STORE = path +"netty_client.jks";
    private static String CLIENT_KEY_STORE_PASSWORD = "changxinjie";
    private static String CLIENT_TRUST_KEY_STORE_PASSWORD = "changxinjie";

    private static String SERVER_KEY_STORE = path +"netty_server.cer";
    private static String SERVER_TRUST_KEY_STORE =path + "netty_server.jks";
    private static String SERVER_KEY_STORE_PASSWORD = "changxinjie";
    private static String SERVER_TRUST_KEY_STORE_PASSWORD = "changxinjie";
    static {
